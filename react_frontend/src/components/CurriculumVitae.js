    ...
    return (
        <div style={styles.frame}>
            ...
            <section>
                ...
                <p style={styles.paragraph}>Machine Learning Engineer with 6+ years of experience, passionate about developing AI and Data solutions. Skilled in Data Science, MLOps, Cloud Engineering, Data Engineering, and Project Management. Proud to have helped grow my current company from a start-up to an established consulting business. Looking forward to connecting!</p>
            </section>
            ...
            <section>
                ...
                <p style={styles.paragraph}>Traveling across Europe on a bike, ski touring in winter, and beer brewing.</p>
            </section>
